      ...
      <div className="max-w-7xl mx-auto px-margin-mobile md:px-margin-desktop">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
          ...
          <div className="flex flex-col gap-2 p-8 border-l-4 border-secondary bg-surface-container-lowest shadow-sm">
            <span className="font-headline text-label-sm text-secondary uppercase tracking-widest">
              Cuándo
            </span>
          ...
          <div className="flex flex-col gap-2 p-8 border-l-4 border-primary bg-surface-container-lowest shadow-sm">
            <span className="font-headline text-label-sm text-primary uppercase tracking-widest">
              Dónde
            </span>
            <h2 className="font-headline text-headline-lg text-primary">
          ...
          {/* Map Card */}
          <div className="flex flex-col gap-2 p-8 border-l-4 border-outline bg-surface-container-lowest shadow-sm">
            <span className="font-headline text-label-sm text-outline uppercase tracking-widest">
              Ubicación
            </span>
            <a 
            ...
            >
              ...
              <span className="ml-2 font-headline text-label-lg">Ver en Mapa</span>
            </a>
          </div>

  ...
  return (
    <section className="relative h-[90vh] flex items-center justify-center overflow-hidden bg-primary">
      ...
      <div className="relative z-20 text-center px-margin-mobile max-w-4xl">
        <img 
          alt="Logo Center" 
          className="w-32 h-32 mx-auto mb-8 drop-shadow-xl dark:drop-shadow-2xl animate-pulse" 
          src={logo}
        />
        
        <h1 className="font-display-lg text-display-lg-mobile md:text-display-lg text-on-secondary mb-4 uppercase leading-tight">

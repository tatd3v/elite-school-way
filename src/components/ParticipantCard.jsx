...
function ParticipantCard({ participant }) {
  ...
  return (
    <div className={`bg-surface-container-lowest border border-outline-variant/30 shadow-md rounded-xl p-5 border-t-4 ${borderColor} relative overflow-hidden transition-colors duration-300`}>
